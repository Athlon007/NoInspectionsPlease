...
os.mkdir("build")
shutil.copyfile(
    "NoInspectionsPlease\\bin\\Release\\NoInspectionsPlease.dll", "build\\NoInspectionsPlease.dll")
shutil.copyfile("PleaseReadMe.txt", "build\\PleaseReadMe.txt")
os.chdir("build")

FILES = []
FILES.extend(["NoInspectionsPlease.dll"])
FILES.extend(["PleaseReadme.txt"])
make_zip(FILES, "NoInspectionsPlease.zip")
